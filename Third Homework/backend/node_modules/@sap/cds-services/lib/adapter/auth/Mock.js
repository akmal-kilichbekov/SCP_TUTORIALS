...
class Mock {
  ...
  _getContext (req) {
    ...
    if (this._credentialsDoNotMatch(credentials.userId, credentials.password)) {
      return this.fail(this._challenge)
    }
  ...
  _credentialsDoNotMatch (userId, password) {
    if (!userId || !this._users[userId]) {
      return true
    }

    const givenPassword = password || ''
    const storedPassword = this._users[userId].password || ''
