...
function assertConsistency( model, stage ) {
  ...
  if (stageParser
    ? !options.testMode && (model.$frontend !== 'json' || options.newCsn === false)
  ...
  const schema = {
    ...
    _redirected: { kind: true, test: TODO }, // for REDIRECTED TO: array of table aliases for targets from orig to new
