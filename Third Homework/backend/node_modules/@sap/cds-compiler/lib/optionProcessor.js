...
optionProcessor
  ...
  Internal options (for testing only, may be changed/removed at any time)
   -R, --raw-output         Write raw augmented CSN and error output to <stdout>, long!
       ...
       --new-redirect-impl  (obsolete) Use new implementation of implicit redirection
       --assoc-on-rewrite   (obsolete) Rewrite ON conditions and keys specification for
                            associations and compositions
       --new-auto-expose    (internal) Do autoexpose in core compiler,
...
optionProcessor.command('toTntSpecificOutput')
  .option('-h, --help')
  .help(`
