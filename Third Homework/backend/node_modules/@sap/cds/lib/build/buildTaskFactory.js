...
const { BUILD_TASK_HANA, BUILD_TASK_FIORI, BUILD_TASK_JAVA, BUILD_TASK_NODE } = require("./constants");
...
class BuildTaskFactory {
    ...
    async getTasks(buildOptions) {
        ...
        if (tasks.length === 0) {
            ...
            if (tasks.length > 0) {
                ...
                this.logger.log("[cds] - You may want to add them to the ./.cdsrc.json of your project and customize to your needs if required.")
            }
        }
    ...
    async _createTasksFromMtaYaml(projectPath) {
        ...
        const modules = await findModules(projectPath, this.logger)
