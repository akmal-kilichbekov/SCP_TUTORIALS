    ...
    return new Promise((resolve, reject) => {
            try {
                ...
                if (!fs.existsSync(buildDirectory)) {
                    ...
                    let pattern = `{portal-site${path.sep},portal-site${path.sep}i18n${path.sep}*}{CommonDataModel.json,.properties}`;
                    // Matches only *.json or *.properties inside folder "portal-site" and "portal-site\i18n
...
async function portalServiceDeploy(archiveStream, appHostIdsXsAppNameServicesMap, token) {
    try {
...
class DeployUtils {
    ...
    3. Fetch technical user token
    4. Send them to the portal service with technical user jwt token
    5. Delete deployment temp folder
     */
    static async deploy() {
